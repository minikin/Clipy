...
@objc protocol CPYSnippetTableView_oldDelegate {
    optional func selectSnippet(row: Int, folder: CPYFolder?)
}

// MARK: - CPYSnippetTableView
class CPYSnippetTableView_old: NSTableView {

    // MARK: - Properties
    internal weak var tableDelegate: CPYSnippetTableView_oldDelegate?
...
extension CPYSnippetTableView_old: NSTableViewDataSource {
...
extension CPYSnippetTableView_old: NSTableViewDelegate {
